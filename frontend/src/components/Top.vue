<template>
  <div class="navbar" style="--wails-draggable:drag">
    ...
    <div class="logo-container">
      ...
      <span class="title">SRSC-KVN1-Client</span>
    </div>
...
<script setup>
import { ref } from 'vue';
import {SetEndpoint} from "../../wailsjs/go/main/FileManager"
...
.navbar {
  ...
  justify-content: space-between;
   /* 稍微增加左右 padding */
  /* -webkit-app-region: drag; /* 允许拖动整个导航栏 */
  /* background-color: #f0f0f0; /* 可选：给导航栏一个背景色 */
